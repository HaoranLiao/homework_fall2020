...
class ACAgent(BaseAgent):
    ...
    def train(self, ob_no, ac_na, re_n, next_ob_no, terminal_n):
        ...
        for _ in range(agent_params['num_critic_updates_per_agent_update']):
            ...
            loss['Critic_Loss'] = self.critic.update( ob_no, ac_na, next_ob_no, reward_n, terminal_n) 
    ...
    def estimate_advantage(self, ob_no, next_ob_no, re_n, terminal_n):
        ...
        # adv_n = TODO
        adv_n = re_n + self.gamma * self.critic(next_ob_no) * np.logical_not(terminal_n) - self.critic(ob_no)
