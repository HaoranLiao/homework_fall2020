...
curve_q2_1 = np.load("/Users/haoran/Documents/GitHub/homework_fall2020/hw2/data/q2_b2000_r0.1.npy")
curve_q2_2 = np.load("/Users/haoran/Documents/GitHub/homework_fall2020/hw2/data/q2_b3000_r0.05.npy")
curve_q2_3 = np.load("/Users/haoran/Documents/GitHub/homework_fall2020/hw2/data/q2_b4000_r0.1.npy")

curve_q3 = np.load("/Users/haoran/Documents/GitHub/homework_fall2020/hw2/data/q3_b40000_r0.005.npy")
...
################## q2 #################
plt.figure()
plt.plot(curve_q2_1, label='b2000_r0.1')
plt.plot(curve_q2_2, label='b3000_r0.05')
plt.plot(curve_q2_3, label='b4000_r0.1')
plt.legend()
plt.show()
