...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        rand_inds = np.random.permutation(range(len(self.obs)))[batch_size:batch_size*2]
        return self.obs[rand_inds], self.acs[rand_inds], self.rews[rand_inds], self.next_obs[rand_inds], self.terminals[rand_inds] 
